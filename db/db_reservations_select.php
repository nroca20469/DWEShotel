             ...
             // echo  $reservation['reservation_status'];
                if($reservation['reservation_status'] == 'booked') {
                    echo '<div class="row">';
                        ...
                        echo "<form action=\"/student045/dwes/form/form_update_extras_customer.php\" method =\"POST\">
                            <input name=\"reservationNum\" value = \"" . $reservation['reservation_number'] . "\" hidden>
                            <button class=\"btn btn-secondary\" type=\"submit\" name=\"submit\">Add extras</button>";
                        echo "</form>";
                    ...
                    echo '</div>';
                echo '</div>';
                } else if($reservation['reservation_status'] == 'check_out') {
                    echo '<div class="row">';
                            echo '<div class="col-5">';
                                echo ('Reservation Number: ' . $reservation['reservation_number'] . 
                                '<br>Date in: ' . $reservation['date_in'] . 
                        ...
                        echo "<form action=\"/student045/dwes/db/db_invoice_select.php\" method =\"POST\">
                            ...
                            <button class=\"btn btn-secondary\" type=\"submit\" name=\"submit\">View Invoice</button>";
                        echo "</form>";
                        echo '</div>';
                    echo '</div>';
                echo '</div>';
