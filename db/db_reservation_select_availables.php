    ...
    <?php
        //Create variable
            ...
            if($date_in == null & $date_out == null){
                echo 'You have no date in or date out, please check again';
                //echo <button> . 'Check again' . </button>;
                echo("<br><button class=\"btn btn-secondary\" onclick=\"location.href='http://localhost/student045/dwes/index.php'\">Home</button>");
            }
        //Connect database 
        ...
        <div class="row pt-4">
            ...
            <div class="col">
                ...
                <?php if ($reservations != null){
                    echo $reservations[0]['room_price'];
                } else {
                    echo 100;
                }
                ...
                <br> 
                <p>Room number: <?php if ($reservations != null){
                    echo $reservations[0]['room_number'];
                } else {
                    echo 'none';
                }

                 ?> </p>
                <a href="" class="pull-right"><button class="btn btn-primary btn-lg" type="button">Book</button></a>
            </div>
        </div>
        ...
        <div class="row pt-4">
            ...
            <div class="col order-1">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="DoubleAmenitiesLabel">Single Room Amenities</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <ul class="list-group list-group-flush"> 
                            ...
                            <li class="list-group-item input-group" >
                                <p class="pt-3"><img src= "http://localhost/student045/dwes/icons/terrace/chair-solid.svg"  height= "20px"  width= "20p         x"  /> Terrace </p>
                            </li>
                            <li class="list-group-item input-group" >
                                <p class="pt-3"><i class="bi bi-tv"></i> Extra bed possible </p>
                            </li>
                ...
                <h5>Price</h5>
                <?php if ($reservations != null){
                    echo $reservations[1]['room_price'];
                } else {
                    echo 200;
                }
                ...
                <br> 
                <p>Room number: <?php if ($reservations != null){
                    echo $reservations[1]['room_number'];
                } else {
                    echo 'none';
                }
        ...
        <div class="row pt-4">
            ...
            <div class="col">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="SuiteAmenitiesLabel">Suite Room Amenities</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                ...
                <p>Room number: <?php if ($reservations != null){
                 ...
                 ?> </p>
                <a href="http://localhost/student045/dwes/db/db_reservations_insert.php" class="pull-right"><button class="btn btn-primary btn-lg" type="button">Book</button></a>
            </div>
        </div>
